...
class MissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mission" do
    assert_difference('Mission.count') do
      post missions_url, params: { mission: { category_id: @mission.category_id, title: @mission.title } }
    end
  ...
  test "should update mission" do
    patch mission_url(@mission), params: { mission: { category_id: @mission.category_id, title: @mission.title } }
